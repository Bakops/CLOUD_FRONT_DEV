    ...
    <div className={`min-h-screen flex items-center justify-center bg-black ${poppins.className}`}>
      <main className="w-full max-w-4xl flex flex-col gap-2 items-center justify-center ">
        ...
        <Link href="/items" className="w-full flex justify-center">
          <button className="px-8 py-3 cursor-pointer animate-bounce rounded-full bg-gradient-to-r from-blue-600 via-purple-500 to-pink-500 text-white font-bold text-lg shadow-xl hover:scale-105 hover:from-blue-700 hover:to-pink-600 transition-all duration-200">

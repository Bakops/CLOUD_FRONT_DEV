...
<div className={`min-h-screen flex items-center justify-center bg-black ${poppins.className}`}> 
  <main className="w-full max-w-4xl flex flex-col gap-2 items-center justify-center "> 
    <Image src="/poulet.gif" alt="Poulet" width={200} height={200} /> 
    <h1 className="text-8xl font-extrabold text-white mb-4 text-center tracking-tight"> Front Cloud </h1> 
    <p className="text-md text-gray-200 mb-10 text-center max-w-md"> Application Next.js moderne connectée à une API Cloud Run.
